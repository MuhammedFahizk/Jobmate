...
function RegisterForm() {
  ...
  const onSubmit = async (data: RegisterPayload) => {
    try {
      ...
      // Show specific validation error or fallback to the general message
      const errorMessage = err?.errors?.[0]?.message || err?.message || 'Registration failed. Please try again.';
