      ...
      <div className="max-w-[1000px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            <span className="inline-flex px-3 py-1.5 rounded-pill bg-brand-accent-light text-brand-accent-dark text-xs font-semibold uppercase tracking-wider self-start shadow-sm">
              Contact Center
            </span>
            <h1 className="font-display text-4xl font-bold tracking-tight text-brand-text leading-tight">
          ...
          <div className="flex flex-col gap-4 mt-4">
            {/* Phone */}
            <div className="bg-brand-surface p-5 rounded-card border border-brand-border shadow-sm flex items-center gap-4">
              ...
              <div>
                <span className="font-body text-[10px] text-brand-muted uppercase tracking-wider font-semibold">Direct Call</span>
                <a href="tel:+919207543772" className="font-display font-semibold text-sm text-brand-text block hover:text-brand-accent transition-colors">
                  9207 543 772
                </a>
              </div>
            </div>
            ...
            <div className="bg-brand-surface p-5 rounded-card border border-brand-border shadow-sm flex items-center gap-4">
              ...
              <div className="min-w-0">
                <span className="font-body text-[10px] text-brand-muted uppercase tracking-wider font-semibold">Email support</span>
                <a href="mailto:mcubeservicesclt@gmail.com" className="font-display font-semibold text-sm text-brand-text block hover:text-brand-accent transition-colors truncate">
            ...
            <div className="bg-brand-surface p-5 rounded-card border border-brand-border shadow-sm flex items-center gap-4">
              ...
              <div>
                <span className="font-body text-[10px] text-brand-muted uppercase tracking-wider font-semibold">Office Location</span>
                <span className="font-display font-semibold text-sm text-brand-text block leading-snug">
        ...
        <div className="lg:col-span-7">
          <motion.div
            className="bg-brand-surface p-8 sm:p-10 rounded-card border border-brand-border shadow-card h-full flex flex-col justify-between"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.4 }}
          >
            <div>
              <h2 className="font-display font-bold text-lg text-brand-text mb-2">
                Send a Message
              </h2>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-card-sm border border-brand-border bg-brand-surface text-brand-text font-body text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent transition-all duration-200"
                    />
                  </div>
                ...
                {/* Subject */}
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="subject" className="font-body text-xs font-semibold text-brand-text uppercase tracking-wider">
                    Subject
                  </label>
                  <input
                    id="subject"
                ...
                {/* Message */}
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="message" className="font-body text-xs font-semibold text-brand-text uppercase tracking-wider">
                    Message Details
                  </label>
                  <textarea
                    id="message"
                    ...
                    className="w-full px-4 py-2.5 rounded-card-sm border border-brand-border bg-brand-surface text-brand-text font-body text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent transition-all duration-200 resize-none"
                  />
                </div>
