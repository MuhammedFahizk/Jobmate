      ...
      <div className="max-w-[1000px] mx-auto px-6 flex flex-col gap-16">
        ...
        <div className="text-center flex flex-col items-center gap-6">
          <motion.span
            ...
            className="inline-flex px-3 py-1.5 rounded-pill bg-primary-100 text-primary-700 text-xs font-semibold uppercase tracking-wider shadow-sm"
          >
            Our Mission & Slogan
          </motion.span>
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-foreground max-w-2xl leading-[1.15]"
          >
        ...
        <motion.div
          ...
          className="bg-white p-8 sm:p-12 rounded-card border border-border shadow-card grid grid-cols-1 md:grid-cols-12 gap-8 items-center"
        >
          <div className="md:col-span-7 flex flex-col gap-4">
            <span className="font-body text-xs font-bold text-primary-500 uppercase tracking-wider">
              The Journey
            </span>
          ...
          <div className="md:col-span-5 bg-primary-50 p-6 rounded-card border border-border flex flex-col gap-4">
            <div className="flex items-center gap-2 text-primary-700">
              <MapPin size={18} />
              <span className="font-display font-semibold text-sm">Corporate Office</span>
            </div>
            <div className="text-xs text-foreground font-body leading-relaxed flex flex-col gap-1">
              ...
              <span className="mt-2 text-primary-700 font-semibold">Phone: +91 9207 543 772</span>
            </div>
          </div>
        </motion.div>
        ...
        <div>
          <div className="text-center mb-12">
            <span className="font-body text-xs font-semibold text-primary-500 uppercase tracking-wider block mb-2">
              Our Pillars
            </span>
            <h2 className="font-display text-2xl font-bold text-foreground">
          ...
          >
            {values.map((val, idx) => (
              <motion.div
                ...
                className="bg-white border border-border p-6 rounded-card flex gap-4 hover:shadow-card transition-all duration-200"
              >
