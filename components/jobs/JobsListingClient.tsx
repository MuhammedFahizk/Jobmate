...
interface JobsListingClientProps {
  initialData?: AdminJobListResponse;
}

function JobsListContent({ initialData }: JobsListingClientProps) {
  const {
...
export function JobsListingClient({ initialData }: JobsListingClientProps) {
  return (
    <Suspense fallback={
      ...
      <JobsListContent initialData={initialData} />
    </Suspense>
  );
}
