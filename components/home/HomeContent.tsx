  ...
  return (
    <div className="overflow-hidden">
              ...
              <motion.div className="grid grid-cols-4 gap-4 pt-6 mt-6 sm:pt-8 sm:mt-8 border-t-[1.5px] border-dashed border-border" variants={itemVariants}>
                <div className="flex items-center -space-x-3 flex-shrink-0">
                  {stackedAvatars.map((src, idx) => (
                    <div key={src + idx} className="relative w-8 h-8 rounded-full bg-primary-300 border-2 border-white shadow-card overflow-hidden" style={{ zIndex: 10 - idx }}>
      ...
      <section className="bg-background py-10 px-6">
        ...
        <div className="mx-auto max-w-[1200px] relative my-16 border-t-[1.5px] border-dashed border-border before:content-[''] before:absolute before:-top-[7px] before:-left-[7px] before:w-3.5 before:h-3.5 before:rounded-full before:bg-background before:border-[1.5px] before:border-border after:content-[''] after:absolute after:-top-[7px] after:-right-[7px] after:w-3.5 after:h-3.5 after:rounded-full after:bg-background after:border-[1.5px] after:border-border" />
      </section>
